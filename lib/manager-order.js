...
const BAND_BASE = { overdue: 0, today: 1000, week: 2000, later: 3000 };
const DAY_STEP = 60;
const UNDATED_SCORE = BAND_BASE.later + 1e9;
...
export function autoScore(item, todayISO) {
  ...
  return BAND_BASE[bandFor(item.when, todayISO)] + days * DAY_STEP + priority;
}
